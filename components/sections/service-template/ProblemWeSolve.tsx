...
export function ProblemWeSolve({ title, paragraphs, quote, closing }: ProblemWeSolveProps) {
  ...
  return (
    <section ref={revealRef} aria-labelledby="problem-heading" className="bg-inverse-surface py-16 md:py-28">
      <Container>
        <div className="grid grid-cols-1 gap-10 md:grid-cols-12">
          ...
          <div data-reveal-item className="md:col-span-8 flex flex-col gap-6 font-sans text-base leading-relaxed text-inverse-content/80 md:text-lg">
            <p>{paragraphs[0]}</p>
            <p>{paragraphs[1]}</p>
            ...
            <blockquote className="border-l-2 border-hairline py-1 pl-6 font-display text-xl font-normal italic leading-snug text-inverse-content">
              &ldquo;{quote}&rdquo;
            </blockquote>
            <p>{closing}</p>
          </div>
