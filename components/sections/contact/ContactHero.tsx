...
export function ContactHero() {
  return (
    <section
      ...
      className="flex min-h-[48vh] items-center bg-ivory py-16 md:py-24"
    >
      <Container className="mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <a
          href="#alt-contact"
          className="mt-6 font-sans text-sm text-ink/60 underline-offset-4 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-ivory"
        >
