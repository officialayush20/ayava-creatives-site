...
export function FounderHero() {
  ...
  return (
    <section
      ...
      className="flex min-h-[60vh] items-center bg-surface py-16 md:py-24"
    >
      <Container>
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12 md:items-center md:gap-8">
          {/* Dawn Mesh (light theme only — no-op in dark), text column only.
              See docs/light-theme-application-map.md, About mapping. */}
          <div
            className="md:col-span-7 bg-[image:var(--gradient-dawn-mesh)] bg-cover"
            data-hero-item
          >
            <p className="mb-4 font-sans text-xs font-medium uppercase tracking-[0.18em] text-content-body">
              About Ayava
            </p>
            <h1 className="font-display text-[length:var(--type-display-hero)] font-normal leading-[1.0] text-content">
              One founder. Full accountability. No account-manager layer.
            </h1>
            <p className="mt-6 max-w-[48ch] font-sans text-base text-content-body md:text-lg">
