    ...
    <section ref={revealRef} aria-labelledby="coming-soon-heading" className="bg-ivory py-16 md:py-24">
      <Container>
        <div className="flex flex-col gap-8">
          ...
          <p className="max-w-[60ch] font-sans text-base text-ink md:text-lg">
            This piece is announced, not yet published. Here&apos;s what it&apos;ll cover when it
            goes live:
          </p>
          {article.talkingPoints ? (
            <ul className="flex max-w-[60ch] flex-col gap-2 pl-6 font-sans text-base text-ink marker:text-bronze" style={{ listStyleType: "disc" }}>
