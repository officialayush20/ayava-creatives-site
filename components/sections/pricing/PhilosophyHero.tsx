  ...
  return (
    ...
    >
      <Container className="mx-auto flex max-w-3xl flex-col items-center text-center">
        ...
        <h1 className="font-display text-[clamp(36px,5vw,72px)] font-normal leading-[1.05] text-ink">
          Every quote is built for the account it&apos;s for — not pulled off a shelf.
        </h1>
        <p className="mt-5 max-w-[56ch] font-sans text-base text-ink/70 md:text-lg">
